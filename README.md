...
- Download the dataset `point_light.zip` from [datasets](https://drive.google.com/drive/folders/1Sr30kdvCD2tXNAONzcnF5xnoMXasylyA?usp=sharing) and unzip it to `./public_data`.
...
You can download training data from [here](https://drive.google.com/drive/folders/1Sr30kdvCD2tXNAONzcnF5xnoMXasylyA?usp=sharing) and unzip them to `./public_data`.

#### On point light RGB inputs

Extract `point_light.zip` and run
...
Extract `directional_light.zip` and run
...
Extract `vertical_down.zip` and run
